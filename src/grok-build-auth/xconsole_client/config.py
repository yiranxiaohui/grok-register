...
# ---- realistic browser fingerprint (Chrome 145 on Windows) ----
# Must stay aligned with FingerprintTransport DEFAULT_IMPERSONATE / client
# impersonate default. Claiming Chrome 148 while impersonating chrome131 caused
# Cloudflare "Attention Required" 403 on accounts.x.ai while real browsers worked.
